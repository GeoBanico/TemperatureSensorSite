...
def get_records():
	...
	if isinstance(range_h_int,int):
		arrow_time_now  = arrow.utcnow()
		arrow_time_from = arrow_time_now.shift(hours=-range_h_int)
	...
	curs 			    = conn.cursor()
	curs.execute("SELECT * FROM temperatures WHERE rDateTime BETWEEN ? AND ?", (from_date_utc.format('YYYY-MM-DD HH:mm:ss'), to_date_utc.format('YYYY-MM-DD HH:mm:ss')))
	temperatures 	    = curs.fetchall()
	curs.execute("SELECT * FROM humidities WHERE rDateTime BETWEEN ? AND ?", (from_date_utc.format('YYYY-MM-DD HH:mm:ss'), to_date_utc.format('YYYY-MM-DD HH:mm:ss')))
